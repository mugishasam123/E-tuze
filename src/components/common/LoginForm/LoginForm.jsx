  ...
  return (
    <div className='w-[25%]'>
        <form className='flex flex-col items-start justify-start w-[100%]'>
            ...
            <input type='password' name='password' id='password' placeholder='Enter your Email' className='border border-gray-500  h-16 w-full rounded-xl placeholder:px-2 p-3 focus:border-green-600 focus:outline-none' />
